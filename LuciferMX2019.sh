#!/usr/bin/env bash
# GOLDEN ADM PRO - LuciferMX2019 REV11 compatible / progreso visible / anti-bloqueo
cd $HOME
...
if [[ "$SERVER_REV" != "REV11" ]]; then
    msg -ama "Aviso: el servidor de keys no reporta REV11; se usará compatibilidad automática 8888/81."
fi
